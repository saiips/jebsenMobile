 ...
 function(oj, ko, $, app) {
    ...
    function performanceViewModel() {
      ...
      self.handleActivated = function(info) {
        ...
        console.log("performance parentRouter=" + parentRouter.currentState().value);
        
        var childRouter = parentRouter.getChildRouter("performance");
        if (!childRouter) {
            childRouter = parentRouter.createChildRouter('performance');
        }
        
        self.router = childRouter.configure({
          'performanceDetail': { value: 'pages/performance/performanceDetail', label: 'Performance', isDefault: true }
        });
