 ...
 function(oj, ko, $, app) {
    ...
    function VistationViewModel() {
      ...
      self.handleActivated = function(info) {
        ...
        var childRouter = parentRouter.getChildRouter("visitation");
        if (!childRouter) {
            childRouter = parentRouter.createChildRouter('visitation');
        }        
        
        self.router = childRouter.configure({
          'visitationList': { value: 'pages/visitation/visitationList', label: 'Visitation / Activities', isDefault: true }
        });
